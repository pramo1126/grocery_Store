...
const AdminBeverages = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/productRoutes/AdminBeverages')
            .then(result => {
    ...
    const handleDelete = (productId) => {
        if (window.confirm('Are you sure you want to delete this product?')) {
            ...
            axios.delete(`http://localhost:8000/productRoutes/AdminBeverages/${productId}`)
                .then(() => {
    ...
    const handleEdit = (productId) => {
        ...
        navigate(`/EditProduct/Beverages&DairyProduct/${productId}`);
        ...
        <div>
            ...
            <div className='px-5 mt-3'>
                <div className='d-flex justify-content-center'>
                  ...
                  <h5>Product List - Beverages & Dairy Product</h5>
