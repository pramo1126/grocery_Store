...
const AdminFrozen = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/productRoutes/AdminFrozen')
            .then(result => {
    ...
    const handleDelete = (productId) => {
        if (window.confirm('Are you sure you want to delete this product?')) {
            ...
            axios.delete(`http://localhost:8000/productRoutes/AdminFrozen/${productId}`)
                .then(() => {
    ...
    const handleEdit = (productId) => {
        ...
        navigate(`/EditProduct/FrozenFoods/${productId}`);
        ...
        <div>
            ...
            <div className='px-5 mt-3'>
                <div className='d-flex justify-content-center'>
                    ...
                    <h5>Product List - Frozen Foods</h5>
