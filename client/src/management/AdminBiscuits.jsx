...
//   <h3>Product List - Biscuits & Snacks</h3>
//       </div>
//   {/* </div>
...
const AdminBiscuits = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8000/productRoutes/AdminBiscuits')
    .then(result => {
  ...
  const handleDelete = (productId) => {
    ...
    axios.delete(`http://localhost:8000/productRoutes/AdminBiscuits/${productId}`)
      .then(() => {
  ...
  const handleEdit = (productId) => {
    ...
    navigate(`/EditProduct/Biscuits&snacks/${productId}`);
 ...
 <h5>Product List - Biscuits & Snacks</h5>
